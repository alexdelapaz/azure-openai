...
function extractSelector(currentSelector, rules2, selector, value, stylesheet2) {
  if (rules2 === void 0) {
    rules2 = { __order: [] };
  }
  if (selector.indexOf("@") === 0) {
    selector = selector + "{" + currentSelector;
    extractRules([value], rules2, selector, stylesheet2);
  } else if (selector.indexOf(",") > -1) {
    expandCommaSeparatedGlobals(selector).split(",").map(function(s) {
      return s.trim();
    }).forEach(function(separatedSelector) {
      return extractRules([value], rules2, expandSelector(separatedSelector, currentSelector), stylesheet2);
    });
  } else {
    extractRules([value], rules2, expandSelector(selector, currentSelector), stylesheet2);
  }
}
...
function styleToRegistration(options) {
  ...
  var stylesheet2 = (_a3 = options.stylesheet) !== null && _a3 !== void 0 ? _a3 : Stylesheet.getInstance(options.shadowConfig);
...
var copyOldGlobalRules = function(stylesheet2, inShadow, win, doc) {
  var _a3;
  if (inShadow === void 0) {
    inShadow = false;
  }
  ...
  if (oldGlobalRules) {
    ...
    for (var i = 0; i < oldGlobalRules.length; i++) {
      ...
      for (var j = 0; j < cssRules.length; j++) {
        var rule = cssRules[j];
        stylesheet2.insertRule(rule.cssText);
      }
    }
  }
};
  ...
  function(_super) {
    ...
    ShadowDomStylesheet2.getInstance = function(shadowConfig) {
      ...
      if (!_stylesheet2 || oldStylesheetInitializedFirst || _stylesheet2._lastStyleElement && _stylesheet2._lastStyleElement.ownerDocument !== doc) {
        ...
        var stylesheet2 = void 0;
        if (oldStylesheetInitializedFirst) {
          stylesheet2 = new ShadowDomStylesheet2(fabricConfig.mergeStyles, JSON.parse(_stylesheet2.serialize()));
          copyOldGlobalRules(stylesheet2, inShadow, win, doc);
        } else {
          stylesheet2 = new ShadowDomStylesheet2(fabricConfig.mergeStyles, fabricConfig.serializedStylesheet);
        }
        _stylesheet2 = stylesheet2;
        global[STYLESHEET_SETTING] = _stylesheet2;
      } else {
...
setVersion("@fluentui/react-window-provider", "2.2.28");
      ...
      ComponentWithInjectedProps.prototype.render = function() {
        ...
        return React12.createElement(MergeStylesShadowRootConsumer, { stylesheetKey: scope }, function(inShadow) {
          return React12.createElement(CustomizerContext.Consumer, null, function(context) {
            ...
            var win = (_a4 = _this.context.window) !== null && _a4 !== void 0 ? _a4 : getWindow();
...
var adoptSheet = function(shadowCtx, doc, stylesheetKey, stylesheet2, listenerRef) {
  var _a3, _b, _c, _d, _e;
  var shadowRoot = shadowCtx.shadowRoot;
  shadowCtx.stylesheets.set(stylesheetKey, stylesheet2);
  if (SUPPORTS_CONSTRUCTABLE_STYLESHEETS) {
    ...
    while (i >= 0 && !found) {
      ...
      var sheetSortOrder = (_d = (_c = stylesheet2.metadata) === null || _c === void 0 ? void 0 : _c.sortOrder) !== null && _d !== void 0 ? _d : 0;
      if (prevSheet.bucketName === "merge-styles" && prevSortOrder < sheetSortOrder) {
        found = true;
      }
    }
    if (SUPPORTS_MODIFYING_ADOPTED_STYLESHEETS) {
      shadowRoot.adoptedStyleSheets.splice(i + 1, 0, stylesheet2);
    } else {
    ...
    if (style.sheet) {
      cloneCSSStyleSheet(stylesheet2, style.sheet);
...
setVersion("@fluentui/utilities", "8.15.19");

// node_modules/@fluentui/react-hooks/lib/useAsync.js
var React22 = __toESM(require_react());
function useAsync() {
  var asyncRef = React22.useRef();
  if (!asyncRef.current) {
...
function useBoolean(initialState) {
  var _a3 = React24.useState(initialState), value = _a3[0], setValue = _a3[1];
...
function useControllableValue(controlledValue, defaultUncontrolledValue, onChange) {
  var _a3 = React26.useState(defaultUncontrolledValue), value = _a3[0], setValue = _a3[1];
  var isControlled2 = useConst(controlledValue !== void 0);
  var currentValue = isControlled2 ? controlledValue : value;
  var valueRef = React26.useRef(currentValue);
  var onChangeRef = React26.useRef(onChange);
...
function useEventCallback(fn) {
  var callbackRef = React27.useRef(function() {
...
function useForceUpdate2() {
  var _a3 = React28.useState(0), setValue = _a3[1];
...
function useId(prefix, providedId) {
  var ref = React29.useRef(providedId);
  if (!ref.current) {
...
function useMergedRefs() {
  ...
  var mergedCallback = React30.useCallback(function(value) {
...
var useMount = function(callback) {
  var mountRef = React31.useRef(callback);
  mountRef.current = callback;
  React31.useEffect(function() {
    var _a3;
    (_a3 = mountRef.current) === null || _a3 === void 0 ? void 0 : _a3.call(mountRef);
  }, []);
};
...
var useMountSync = function(callback) {
  var mountRef = React32.useRef(callback);
  mountRef.current = callback;
...
function useOnEvent(element, eventName, callback, useCapture) {
  var callbackRef = React33.useRef(callback);
...
function useTarget(target, hostElement) {
  var _a3, _b, _c;
  var previousTargetProp = React37.useRef();
  var targetRef = React37.useRef(null);
  ...
  if (!target || target !== previousTargetProp.current || typeof target === "string") {
    ...
    if (target) {
      if (typeof target === "string") {
        if ((_a3 = currentElement === null || currentElement === void 0 ? void 0 : currentElement.getRootNode()) === null || _a3 === void 0 ? void 0 : _a3.host) {
...
var useUnmount = function(callback) {
  var unmountRef = React38.useRef(callback);
...
function useWarnings(options) {
  if (true) {
    ...
    var hasWarnedRef = React39.useRef(false);
...
//# sourceMappingURL=chunk-MRTSGAL7.js.map
